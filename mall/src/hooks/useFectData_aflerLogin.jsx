...
import { cartReducer } from "../service/cartReuducer";
import AxiosFun from "../service/AxiosFun";
const useFectData_aflerLogin = () => {
  ...
  return [state, setCart, currentUser, setcurrentUser];
};

export default useFectData_aflerLogin;
